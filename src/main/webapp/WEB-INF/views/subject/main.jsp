  ...
  <body>
    ...
    <div class="container mt-3">
      <div class="row align-items-center">
        <div class="col">
          <h3 class="display-3">Subject List</h3>
        </div>
        <div class="col text-end mt-3">
          <span type=button class="btn rounded-0" data-bs-toggle="modal" data-bs-target="#addSubject">
              ...
              <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content rounded-0">
                  <div class="modal-header">
                    <h3 class="modal-title display-6">New Subject</h3>
                  ...
                  <div class="modal-footer">
                    <button type="submit" class="btn btn-dark rounded-0">Add New Subject</button>
                  </div>
                </div>
              </div>
            </div>
      ...
      <ol class="list-group rounded-0">
        <c:forEach var="sbj" items="${subjectList}" varStatus="loop">
          <li class="list-group-item d-flex justify-content-between align-items-start">
            ...
            <span>
              <a href="/subject/${sbj.id}/delete" class="btn btn-outline-dark border-0" role="button">
